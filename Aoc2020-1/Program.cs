...
for (int i = 0; i < nums.Length; i++)
	for (int j = i + 1; j < nums.Length; j++)
		for (int k = j + 1; k < nums.Length; k++)
			...
			{
				System.Console.WriteLine($"[{nums[i]}] * [{nums[j]}] * [{nums[k]}] = {nums[i] * nums[j] * nums[k]}");
				//n1 = i;
				//n2 = j;
				//n3 = k;
				break;
...
sw.Stop();
//System.Console.WriteLine($"[{nums[n1]}] * [{nums[n2]}] * [{nums[n3]}] = {nums[n1] * nums[n2] * nums[n3]}");
